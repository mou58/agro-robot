...
//recive  x 
   ...
   while( radio.available() )
    {
     ...
     if(d>300&&d<450){
    int di = map(d, 225, 535, 145, 80); 
   myservo0.write(75);
   int rgg=myservo4.read();
    delay(100);
   if(rgg<di && di>0){
      for (pos = rgg; pos <= di; pos += 1) { // goes from 0 degrees to 180 degrees
    // in steps of 1 degree
    myservo4.write(pos);              // tell servo to go to position in variable 'pos'
    delay(20);                       // waits 15ms for the servo to reach the position
  }
     ...
     for (pos = rgg; pos >= di; pos -= 1) { // goes from 180 degrees to 0 degrees
    myservo4.write(pos);              // tell servo to go to position in variable 'pos'
    delay(20);
   }
   }
  ...
  delay(100);
   ...
   next=0; 
      ...
      int del = map(d, 750,450 , 1350, 300);
        reverse();
  Speed_C();
  delay(del);
    Stop();
...
//UNLOAD
      ...
      for (pos = 75; pos <=160; pos += 1) { // goes from 0 degrees to 180 degrees
    // in steps of 1 degree
...
delay(300);
   ...
   for (pos = 95; pos <= 180; pos += 1) { // goes from 180 degrees to 0 degrees
    ...
    delay(20);
        ...
        for (pos = 160; pos >=72; pos -= 1) { // goes from 0 degrees to 180 degrees
    // in steps of 1 degree
 myservo7.write(pos); // tell servo to go to position in variable 'pos'
    delay(20);                       // waits 15ms for the servo to reach the position
  }
