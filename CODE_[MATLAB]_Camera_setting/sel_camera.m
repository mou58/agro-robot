...
si=findstr(list_f,'YUY2_720x576');
if isempty(si)
    % msgbox('NO existe')
    es_web_ext=0;
    % Laptop webcam: YUY2
...
% --- Otherwise, executes on mouse press in 5 pixel border or over ok_b.
function ok_b_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to ok_b (see GCBO)
